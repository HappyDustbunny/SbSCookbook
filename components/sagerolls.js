class Sagerolls extends HTMLElement {
  constructor() {
    super();
  }
  connectedCallback() {
    ...
    <div class="insertedIngredienser">
    	<p class="antal">(16 rolls, serves 4-8)		 (Start 1½ hours before)</p>
    	<b>Ingredients:</b>
    ...
    <div class="insertedHowto"> <b> Method: </b>
    	...
    	<p><label><input type="checkbox">Turn on the oven at 200°C (remember to remove the plates)</label></p>
...
customElements.define('sagerolls-recipe', Sagerolls);
